	...
	<div class="container">
		...
		<form class="form-horizontal" id="dictionaryForm" method="post" action="/dictionaryManage.devys">
			...
			<div class="form-inline"><p class="text-info">단어개수 <%=dictionarySize%>개</p>
				...
				<a href="/adminMain.devys" class="btn  btn-small btn-success">관리자 메인으로</a>
			</div>
			<div class="control-group">
				...
				<div class="controls">
					...
					<button class="btn btn-small btn-primary" type="button" onclick="javascript:addWord();">단어추가</button>
				</div>
			</div>
			<div class="control-group">
				...
				<div class="controls">
					...
					<button class="btn btn-small btn-primary" type="button" onclick="javascript:findWord();">단어찾기</button>
				</div>
			</div>
			<div class="control-group">
