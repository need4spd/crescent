...
public class SampleDataMaker {
	public static void main(String[] args) {
		...
		String field_name_1 = "we_wiki_idx";
		String field_name_2 = "we_space_idx";
		String field_name_3 = "we_wiki_text";
		String field_name_4 = "we_wiki_title";
		...
		for(int i = 0; i < 5000; i++) {
			...
			doc.put(field_name_2, String.valueOf(i/1000));
			doc.put(field_name_3, "텍스트 입니다"+i);
			doc.put(field_name_4, "제목 입니다"+i);
